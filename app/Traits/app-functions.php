...
trait appFunction {
    ...
    public function errorMsgs($info){
		...
		switch($info){
			case $info == 1: return ['error'=>1,'msg'=>'Error! Fill all required fields!.']; break;
			case $info == 2: return ['error'=>1,'msg'=>'Error! Passwords do not match.']; break;
			case $info == 3: return ['error'=>1,'msg'=>'Error! Wallet Address does not match.']; break;
			case $info == 4: return ['error'=>1,'msg'=>'Error! Registration Failed.']; break;
			case $info == 5: return ['error'=>1,'msg'=>'Error! Query could not be executed.']; break;
			case $info == 6: return ['error'=>1,'msg'=>'Error! Invalid parameters.Empty arrays.']; break;
			case $info == 7: return ['error'=>1,'msg'=>'Error! Invalid parameter. Parameter must be array.']; break;
			case $info == 8: return ['error'=>1,'msg'=>'Error! Email already exists! Try another one.']; break;
			case $info == 9: return ['error'=>1,'msg'=>'Error! Referral email does not exist.']; break;
			case $info == 10: return ['error'=>1,'msg'=>'Error! Bitcoin Wallet Address already exist.']; break;
			case $info == 11: return ['error'=>1,'msg'=>'Error! Email does not exist.']; break;
			case $info == 12: return ['error'=>1,'msg'=>'Error! Please Image type should be: jpg, png, gif or jpeg.']; break;
			case $info == 13: return ['error'=>1,'msg'=>'Error! Password length should be between 8 - 36 characters.']; break;
			case $info == 14: return ['error'=>1,'msg'=>'Database Error!. If error persists, please kindly contact your administrator!']; break;
			case $info == 15: return ['error'=>1,'msg'=>'System Error!. If error persists, please kindly contact your administrator!']; break;
			case $info == 16: return ['error'=>1,'msg'=>'Error! Title provided already exists!']; break;
			case $info == 17: return ['error'=>1,'msg'=>'Error! Select some fields to proceed!']; break;
			case $info == 18: return ['error'=>1,'msg'=>'Error! Enter a valid Email address!']; break;
			case $info == 19: return ['error'=>1,'msg'=>'Error! Username already exists! Try another one.']; break;
			case $info == 20: return ['error'=>1,'msg'=>'Error! Enter firstname and lastname.']; break;
			case $info == 21: return ['error'=>1,'msg'=>'Error! Insufficient Funds for this transaction.']; break;
