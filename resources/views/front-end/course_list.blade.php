                ...
                <div class="box">
                    <div class="box-body">
                        <div class="bg-light p-10 d-lg-flex justify-content-between align-items-center mb-20 rounded">
                            <h2 class="mb-lg-0 mb-20">List of courses for {{ucfirst($course_category->name)}} category</h2>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            @if(count($course_category->courses) > 0)
                                <div class="tab-pane fade show active" id="pills-list" role="tabpanel" aria-labelledby="pills-list-tab">
                                    @foreach($course_category->courses as $j => $each_course)
                        ...
                        <div aria-label="Page navigation example">
                            <ul class="pagination mb-0">
                                <li class="page-item"><a class="page-link" href="{{$course_category->courses->previousPageUrl()}}">Previous</a></li>
                                <li class="page-item"><a class="page-link" href="#">{{$course_category->courses->currentPage()}}</a></li>
                                <li class="page-item"><a class="page-link" href="{{$course_category->courses->nextPageUrl()}}">Next</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
