                ...
                <div class="box box-body p-40 bg-dark mb-0">
                    ...
                    <div class="widget font-size-18 my-20 py-20 by-1 border-light">
                        <ul class="list list-unstyled text-white-80">
                            <li class="pl-40"><i class="ti-location-pin"></i>123, Lorem Ipsum, Dummy City,<br>FL-12345 USA</li>
                            <li class="pl-40 my-20"><i class="ti-mobile"></i>+(1) 123-878-1649</li>
                            <li class="pl-40"><i class="ti-email"></i>info@EduAdmin.com</li>
                        </ul>
                    </div>
