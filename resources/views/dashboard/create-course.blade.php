													...
													<div class="row">
														...
														<div class="col-lg-12 col-md-12">
															<div class="ui search focus mt-30 lbel25">
																...
																<div class="ui left icon input swdh19">
																	<input class="prompt srch_explore" type="text" placeholder="Summarize in a sentence" name="subtitle" data-purpose="edit-course-title" maxlength="60" id="sub[title]" value="">
