                                                                ...
                                                                <table class="table ucp-table">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-center cell-ta" scope="col">{{auth()->user()->getAmountForView($eachDownlineArray->bonus_details->sum('amount_paid'))['data']['currency']}} {{number_format(auth()->user()->getAmountForView($eachDownlineArray->bonus_details->sum('amount_paid'))['data']['amount'], 2)}} </td>
                                                                            ...
                                                                            {{number_format(auth()->user()->getAmountForView($eachDownlineArray->bonus_details->sum('amount'))['data']['amount'], 2)}}</td>
