									...
									<ul class="_ttl120">
										...
										<li>
											<div class="_ttl121">
												...
												<div class="_ttl123">{{ count($courses) }}</div>
											</div>
										</li>
										<li>
											<div class="_ttl121">
												...
												<div class="col-lg-3 col-md-4">
													<div class="fcrse_1 mt-30">
														<a href="course_detail_view.html" class="fcrse_img">
															<img src="/storage/course-img/{{ $e->cover_image}}" width="218.5px" height="122.91">
														...
														<div class="fcrse_content">
															...
															<a href="course_detail_view.html" class="crse14s">{{ $e->name}}</a>
															<a href="#" class="crse-cate">Web Development | Python</a>
															<div class="auth1lnkprce">
																<p class="cr1fot text-capitalize">By <a href="#">{{ $user->name }} {{ $user->last_name }}</a></p>
