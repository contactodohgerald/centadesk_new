				...
				<div class="modal-content">
					...
					<form class="delete_course_form">
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-sm-12">
									<h4 class=" night-text text-danger">By clicking continue, this category will be deleted permanently. <br> Every course under this category will also be deleted.</h4>
								</div>
							</div>
						</div>
					</form>
