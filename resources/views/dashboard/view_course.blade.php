                        ...
                        <div class="section3125">
                            <div class="row justify-content-center">
                                <div class="col-xl-4 col-lg-5 col-md-6">
                                    ...
                                    <div class="_215b10">
                                        <a href="javascript:;" onclick="saveCourse('{{$course->unique_id}}', '{{auth()->user()->unique_id}}')" class="_215b11 font-poppins" title="Save Course">
                                            ...
                                            ?>
                                            @endif
                                            <span class="text-{{$color}}"><i class="uil uil-heart "></i>{{$text}}</span>
                                        </a>
                                    </div>
                                    <div class="_215b10">
                                ...
                                <div class="col-xl-8 col-lg-7 col-md-6">
                                    ...
                                    <div class="_215b05 font-poppins">
                                        <strong>Last updated:</strong> {{$course->created_at->diffForHumans()}}
                                    </div>
                                    <div class="_215b05 font-poppins">
                                        ...
                                        <div id="accordion" class="ui-accordion ui-widget ui-helper-reset">
                                            <a href="javascript:;" class="accordion-header">
                                                <div class="section-header-left">
                                                    <span class="section-title-wrapper">
                                                        <i class='uil uil-presentation-play crse_icon'></i>
                                                        <span class="section-title-text text-center">NO Data Was Returned At This Time</span>
                                                    </span>
                                                </div>
                                            </a>
                                        </div>
                                                        ...
                                                        <div class="tutor_content_dt">
                                                            ...
                                                            @if($e->user_enroll->user_type != 'student')
                                                                ...
                                                                <div class="tut1250">
                                                                    ...
                                                                    <span class="vdt15">{{$e->user_enroll->course_count}} Courses</span>
                                                                </div>
                                                            @endif
                                                        </div>
                                                    </div>
