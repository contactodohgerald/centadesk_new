										...
										<div class="chat_header">
											<div class="user-status">
												<p style="padding-left: 0px" class="user-status-title">
                                                    <span class="bold ">
                                                        <h2 style="margin-top: 0px;" class="text-center">Title: Lorem ipsum dolor sit. Ducimus, eum?</h2>
                                                    </span>
                                                </p>
											</div>
											<div class="user-status">
												...
												<p style="margin-bottom: 0px;" class="user-status-title"><span class="bold">{{ $ticket_creator->name }} {{ $ticket_creator->last_name }}</span></p>
