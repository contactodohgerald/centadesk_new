			...
			<div class="row">
				<div class="col-md-12">
					<div class="cmtk_group">
						<div class="ct-logo">
							<a href="/"><img src="{{asset('dashboard/images/ct_logo.svg')}}" alt=""></a>
						</div>
						<div class="cmtk_dt">
							<div class="row">
								<div class="col-lg-8 offset-2">
									...
									<form method="POST" action="{{ route('create_complain') }}">
										...
										<select class="ui hj145 dropdown cntry152 prompt srch_explore" name="reasons">
										...
										<div class="ui search focus mt-15">
											<div class="ui left icon input swdh95">
												<input class="prompt srch_explore" type="email" name="email" id="email"  placeholder="Email">
										...
										<div class="ui search focus mt-15">
											<div class="ui form swdh30">
												<div class="field">
													<textarea rows="5" name="description" id="id_about" placeholder="Write a little description ..."></textarea>
												</div>
											</div>
